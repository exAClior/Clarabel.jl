# Note: this is a clone of directldl_utils.jl
# For testing purposes, leave as is to test MINRES solver
# todo: edit this file to remove unnecessary dependencies

using SparseArrays

struct MINRESDataMap
    ...
    function MINRESDataMap(Pmat,Amat,cones)
